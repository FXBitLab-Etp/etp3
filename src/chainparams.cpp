...
{
    const char* pszTimestamp = "Wired 07/July/2017 The Grand Experiment Goes Live: DinarDirham on Blockchain";
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04D9BC30A8E9816A6AF525F00F4F0B70DA9B0FAAEE6334A2FCC0B16B9C5D5256EFD143DB3071E29CFEB891AA2420C124167C60EA482FA09DFA7EC4C15D7944FF60");
        nDefaultPort = 7899;
        nMaxTipAge = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in bitcoin
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1502958442, 0, 0x1e0ffff0, 1, 200000 * COIN);
	...
	if (true && genesis.GetHash() != consensus.hashGenesisBlock)
        {
            ...
            for(genesis.nNonce = 0; genesis.GetHash().GetCheapHash() > consensus.powLimit.GetCheapHash(); genesis.nNonce++){ } 
            LogPrintf("new mainnet genesis merkle root: %s\n", genesis.hashMerkleRoot.ToString().c_str());
            LogPrintf("new mainnet genesis nonce: %u\n", genesis.nNonce);
            LogPrintf("new mainnet genesis hash: %s\n", genesis.GetHash().ToString().c_str());
        }
	//printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x8a9547c0505efdcf1cf7911e2a317279d6f7d953b7ef4846114b39a5a711161d"));
	//printf("genesis.hashMerkleRoot = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(genesis.hashMerkleRoot == uint256S("0xdad8a7a990af48384cb29fe1925bbbb44bf245fe5620ade8607f3c434b7dee2b"));
	...
	vSeeds.clear();
        ...
        strMasternodePaymentsPubKey = "04CBB5E4091818E93A6DF12A07AF5CFD22CE61B4FCDC2853066BAC30824BEAF6DE515C21372FE191F86AF19DCD27D10B9CC3EAF29BA91052BA142EC742E7DE7D51";
...
public:
	...
	//printf("testnet : genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x5f17040958151a5790237a1028515305609d291f4653b869fc16a5af7546ed10"));
...
public:
	...
	//printf("regtestnet : genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("0x5f17040958151a5790237a1028515305609d291f4653b869fc16a5af7546ed10"));
	//printf("regtestnet : genesis.hashMerkleRoot = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(genesis.hashMerkleRoot == uint256S("0xdad8a7a990af48384cb29fe1925bbbb44bf245fe5620ade8607f3c434b7dee2b"));
